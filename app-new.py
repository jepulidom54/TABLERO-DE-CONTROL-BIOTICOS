...
hidrobiota_kale = dbc.Card(
    dbc.CardBody([
            ...
            html.Div([
                dcc.Tabs(id="tabsgraph_h_Platero", value='tab-graph3', children=[
...
metabarcoding_kale = dbc.Card(
    dbc.CardBody([
            ...
            html.Div([
                dcc.Tabs(id="tabsgraph_m_Platero", value='tab-graph4', children=[
...
flora_platero = dbc.Card(
    dbc.CardBody([
            ...
            html.Div([
                ...
                dcc.Tabs(id="tabsgraph_f_Platero", value='tab-graph7', children=[
...
hidrobiota_platero = dbc.Card(
    dbc.CardBody([
            ...
            html.Div([
                ...
                dcc.Tabs(id="tabsgraph_f_Platero", value='tab-graph8', children=[
...
metabarcoding_platero = dbc.Card(
    dbc.CardBody([
            ...
            html.Div([
                ...
                dcc.Tabs(id="tabsgraph_f_Platero", value='tab-graph9', children=[
...
@app.callback(Output('tabs-contentgraph_kale_f', 'children'),
              Input('tabsgraph_f_kale', 'value'))
def render_content(tab):
    if tab == 'tab-1graph-f':
        return html.Div([
            html.H3('Numero de Individuos'),
            dcc.Graph(
                id='graph-1-tabs-dcc-f',
                figure= fig1
            )
        ])
...
"""
@app.callback(Output('tabs-contentgraph_kale_v', 'children'),
              Input('tabsgraph_v_kale', 'value'))
def render_content(tab):
    if tab == 'tab-1graph-v':
        return html.Div([
            html.H3('Biomasa'),
...
@app.callback(Output('tabs-contentgraph_kale_h', 'children'),
              Input('tabsgraph_h_kale', 'value'))
def render_content(tab):
    if tab == 'tab-1graph-h':
        return html.Div([
...
@app.callback(Output('tabs-contentgraph_kale_m', 'children'),
              Input('tabsgraph_m_kale', 'value'))
def render_content(tab):
    if tab == 'tab-1graph-m':
        return html.Div([
...
@app.callback(Output('tabs-contentgraph_platero', 'children'),
              Input('tabsgraph_f_platero', 'value'))
