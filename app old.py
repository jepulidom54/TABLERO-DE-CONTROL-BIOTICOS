...
def graf_bar_f(DataFrame):
    ...
    fig.update_yaxes(title_text="Numbero de Individuos")
    fig.show()
    return fig
...
fig5 = graf_bar_v(dv1)
fig6 = graf_bar_v(dv2)
fig5a = graf_bar_v2(dv1)
fig6b = graf_bar_v2(dv2)
...
fauna_kale = dbc.Card(
    dbc.CardBody([
            ...
            html.Div([
                ...
                dcc.Tabs(id="tabsgraph_f", value='tab-1graph', children=[
